...
public class BixolonPrinter implements ErrorListener, OutputCompleteListener, StatusUpdateListener, DirectIOListener, DataListener
{
    ...
    private String getProductName(String name)
    {
        ...
        else if((name.indexOf("AP3") >= 0))
        {
            productName = BXLConfigLoader.PRODUCT_NAME_AP3;
        }
    ...
    public boolean printText(String data, int alignment, int attribute, int textSize)
    {
        ...
        try
        {
            ...
            Log.e("imprimio1 ",posPrinter.getDeviceControlDescription());
            Log.e("imprimio2 ",posPrinter.getDeviceEnabled()+"");
            Log.e("imprimio3 ",posPrinter.getErrorLevel()+"");
            Log.e("imprimio4 ",posPrinter.getPowerState()+"");
            Log.e("imprimio5 ",posPrinter.getPowerNotify()+"");
            Log.e("imprimio6 ",posPrinter.getCapPowerReporting()+"");
            Log.e("imprimio7",posPrinter.getClaimed()+"");
            */
